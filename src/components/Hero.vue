<template>
  <div class="bg-white/30 dark:bg-black/40 w-full h-full absolute top-0 -z-[1] overflow-hidden">
...
.hero {
  ...
  background: url('./assets/noise.png'), radial-gradient(circle at right center, #563277, #23212a 30%, #4172c2 55%, #32517380);
